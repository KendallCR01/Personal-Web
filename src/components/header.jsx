    ...
    <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-sm fixed w-full top-0 z-50">
      <div className="w-full px-6 md:px-12 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8 text-sm font-medium text-gray-700 dark:text-gray-200">
          ...
          <a href="#sobremi" className="hover:text-blue-600 dark:hover:text-blue-400 transition">Sobre mí</a>
      ...
      {isOpen && (
        <nav className="md:hidden bg-white dark:bg-gray-900 border-t dark:border-gray-800 text-gray-700 dark:text-gray-200 font-medium px-4 py-4 space-y-3 shadow">
          <a href="#inicio" className="block hover:text-blue-600 dark:hover:text-blue-400 transition">Inicio</a>
          <a href="#sobremi" className="block hover:text-blue-600 dark:hover:text-blue-400 transition">Sobre mí</a>
          <a href="#proyectos" className="block hover:text-blue-600 dark:hover:text-blue-400 transition">Proyectos</a>
          <a href="#contacto" className="block hover:text-blue-600 dark:hover:text-blue-400 transition">Contacto</a>
        </nav>
      )}
    </header>
  );
